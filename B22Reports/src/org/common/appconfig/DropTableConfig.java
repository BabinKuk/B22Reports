...
public class DropTableConfig {
	 ...
	 */
	protected DropTableConfig(String inputFile, IInputParamHandler inputParamHandler) {
		...
		try {
			...
			*/			
			...
			sax.parse(input, new DropTableHandler(inputParamHandler));
	...
	static public DropTableConfig getInstance(String inputFile, IInputParamHandler handler) {
		log.info("--------reading configuration file---------");
		if (uniqueInstance == null) {
			//System.out.println("null");
			uniqueInstance = new DropTableConfig(inputFile, handler);
		}
